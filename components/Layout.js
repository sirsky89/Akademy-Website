...
export default function Layout({ title, children }) {
  ...
  return (
    <>
      <Head>
        <title>{title ? title + ' - Akademy' : 'Amazona'}</title>
        ...
        <header>
          <nav className="flex h-16 items-center px-3 justify-between shadow-md">
            <div className="flex items-center">
              ...
              />
              <Link href="/">
                <a className="text-lg font-bold uppercase">Akademy</a>
              </Link>
            </div>
            <div>
              <Link href="/cart">
                <a className="p-2 uppercase font-bold mr-2">
                  Cart
                  {cartItemsCount > 0 && (
              ...
              {status === 'loading' ? (
                ...
                <Menu as="div" className="relative inline-block">
                  ...
                  <Menu.Items className="absolute right-0 w-56 origin-top-right bg-rose-300  shadow-lg">
                    <Menu.Item>
